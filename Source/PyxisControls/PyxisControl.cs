...
using PyxisControls.Extensions;
...
namespace PyxisControls
{
    public abstract class PixivControl<T> : Control where T : DependencyObject
    {
        ...
        protected PixivControl()
        {
            ...
            _pixivCacheStorage = PyxisInjector.Instance.Inject<IFileCacheStorage>();
        }
        ...
        private async void SetSource(object source)
        {
            ...
            var uri = source as Uri ?? (source is string s ? new Uri(s) : null);
